...
#include <memory>
#include "../../ElevatorSystem/Passenger.h"
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_Passenger_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_Passenger_t qt_meta_stringdata_Passenger = {
    {
...
Q_CONSTINIT static const uint qt_meta_data_Passenger[] = {
...
Q_CONSTINIT const QMetaObject Passenger::staticMetaObject = { {
    ...
    qt_meta_stringdata_Passenger.offsetsAndSizes,
    qt_meta_data_Passenger,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_Passenger_t,
        // Q_OBJECT / Q_GADGET
